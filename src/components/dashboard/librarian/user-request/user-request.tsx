          ...
          requestData.map((item) => (
            <GeneralInfosCard key={item.id}>
              <GeneralInfosCard.Content> 
                <GeneralInfosCard.Content.ContentItem label="Title" content={item.title} />
                <GeneralInfosCard.Content.ContentItem label="Author" content={item.author} />
                <GeneralInfosCard.Content.ContentItem label="createdAt" content={formatDate(item.createdAt)} />
                <GeneralInfosCard.Content.ContentItem label="publisher" content={item.publisher} />
                <GeneralInfosCard.Content.ContentItem label="year" content={item.year} />
                <GeneralInfosCard.Content.ContentItem label="genre" content={item.genre} />
              </GeneralInfosCard.Content>
              <GeneralInfosCard.Footer>
                <Button onClick={() => removeRequest(String(item.id))} fontSize='1rem' background='#055A8C' color='#fff' padding='.25rem 1.125rem'>viewed <Image src={icons.eyeViewIcon} alt="eye view icon" /></Button>
              </GeneralInfosCard.Footer>
            </GeneralInfosCard>
          ))
        }
